...
CREATE TYPE event_stage AS ENUM ('College Round', 'State Quarter Finals', 'State Semi Finals', 'Final Round');
CREATE TYPE event_status AS ENUM ('Draft', 'Pre-Event', 'Live', 'Completed');
