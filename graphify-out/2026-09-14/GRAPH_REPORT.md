...
## Corpus Check
- 136 files · ~185,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1100 nodes · 2987 edges · 82 communities (56 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4958afa1`
...
### Community 1 - "Learner"
Cohesion: 0.18
Nodes (23): DaysActivitiesTabProps, AddLearnerModalProps, AllocationModal(), AllocationModalProps, AllocationTabProps, AnalyticsTab(), AnalyticsTabProps, CabinetTabProps (+15 more)
...
Cohesion: 0.15
Nodes (16): EditDayActivitiesModal(), EditDayActivitiesModalProps, ProceedingsTab(), ProceedingsTabProps, QuestionnaireTab(), QuestionnaireTabProps, EventDay, EventDayStatus (+8 more)

### Community 5 - "CollegeEvent"
Cohesion: 0.28
Nodes (17): EventTabRouteHandlerProps, StandaloneProjectorDisplayProps, ControlTabProps, ProjectorTabProps, ReportTabProps, JuryDashboardProps, StudentDashboardProps, VolunteerDashboardProps (+9 more)
...
Cohesion: 0.06
Nodes (65): AllocationTab(), CabinetTab(), DEFAULT_CUSTOM_ITEMS, DEFAULT_MINISTRIES, DEFAULT_MINISTRY_ITEMS, DEFAULT_SELECTED_IDS, getStoredCustomMinistries(), MinistryItem (+57 more)

### Community 8 - "UserRole"
Cohesion: 0.09
Nodes (27): papaparse, ChecklistTab(), ChecklistTabProps, CommitteesTab(), SearchableChairpersonSelectProps, JuryTab(), JuryTabProps, ALL_NOMINATION_ROLES (+19 more)

### Community 10 - "react"
Cohesion: 0.07
Nodes (29): lucide-react, react, EditEventModal(), EditEventModalProps, EventOverviewTab(), EventOverviewTabProps, MyEventsDashboardProps, SuperAdminDashboardProps (+21 more)

### Community 11 - "VolunteerDashboard.tsx"
Cohesion: 0.15
Nodes (15): DaysActivitiesTab(), COMM_STEPS, CONDUCT_STEPS, JuryDashboard(), ORIGINALITY_STEPS, RELEVANCE_STEPS, RESEARCH_STEPS, TIME_STEPS (+7 more)
...
### Community 14 - "ElectionsTab.tsx"
Cohesion: 0.36
Nodes (9): CONSTITUTIONAL_POSTS, ElectionsTab(), ElectionsTabProps, getProjectorSettings(), ProjectorTab(), saveProjectorSettings(), ElectionCandidate, FlashVoteAudience (+1 more)
...
Cohesion: 0.10
Nodes (32): react-router-dom, assert(), runTests(), App(), EventSlugOnlyRedirector(), EventTabRouteHandler(), getInitialRouteInfo(), getInitialSavedSession() (+24 more)
...
Cohesion: 0.10
Nodes (28): CreateEventModal(), CreateEventModalProps, EditCoordinatorModal(), EditCoordinatorModalProps, AddLearnerModal(), CsvImportModal(), CsvImportModalProps, ImportReportData (+20 more)
...
- **Why does `storageService` connect `storageService` to `.getLearners`, `Learner`, `index.ts`, `CollegeEvent`, `storageService.ts`, `UserRole`, `react`, `VolunteerDashboard.tsx`, `.getEventDays`, `ElectionsTab.tsx`, `App.tsx`, `csvHelper.ts`, `AgendaTab.tsx`, `.getEvents`, `.setItem`, `.getParties`, `verify_question_flow.js`, `verify_question_flow.ts`, `.getVolunteers`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `@supabase/supabase-js` connect `@supabase/supabase-js` to `package.json`, `storageService.ts`, `fix_party1_learners.cjs`, `restore_voting_history.cjs`, `check_ahs.cjs`, `check_all_cabinet.cjs`, `check_cabinet_custom.cjs`, `check_yuva_db.cjs`, `clean_arts_cabinet.cjs`, `clean_yuva_db.cjs`, `fix_ahs_event.cjs`, `inspect_ahs.cjs`, `test_attendance_logic.cjs`, `test_batch_attendance_logic.cjs`, `diagnose_bugs.cjs`, `investigate_jkkncet_db.cjs`, `sync_legit_event_days.cjs`, `test_att_payload.cjs`, `test_cols.cjs`, `test_rpc.cjs`, `test_sync_days.cjs`, `test_unknown_col.cjs`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Learner`, `package.json`, `index.ts`, `CollegeEvent`, `storageService.ts`, `UserRole`, `VolunteerDashboard.tsx`, `ElectionsTab.tsx`, `App.tsx`, `csvHelper.ts`, `AgendaTab.tsx`?**
