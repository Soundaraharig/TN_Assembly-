...
## Corpus Check
- 150 files · ~216,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1223 nodes · 3293 edges · 91 communities (65 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c5a2fae`
...
Cohesion: 0.06
Nodes (59): AllocationTab(), CabinetTab(), MinistryItem, SearchableDelegateSelect(), EditLearnerModal(), ParticipantsTab(), INITIAL_AGENDA, INITIAL_CHAT (+51 more)
...
Cohesion: 0.09
Nodes (48): AddLearnerModal(), AddLearnerModalProps, AllocationModal(), AllocationModalProps, AllocationTabProps, AnalyticsTab(), AnalyticsTabProps, CabinetTabProps (+40 more)
...
Cohesion: 0.06
Nodes (3): uid(), ElectionBackupSnapshot, VoteAuditEntry

### Community 25 - "Volunteer"
Cohesion: 0.50
Nodes (4): AccessCodeAuthResult, StudentJoinView(), StudentJoinViewProps, Volunteer
...
Cohesion: 0.09
Nodes (27): DaysActivitiesTab(), EditDayActivitiesModal(), EditDayActivitiesModalProps, AgendaTab(), AgendaTabProps, CATEGORY_OPTIONS, DURATION_PRESETS, ChatTab() (+19 more)
...
## Knowledge Gaps
- **470 isolated node(s):** `$schema`, `npm`, `name`, `baseURL`, `type` (+465 more)
...
- **Why does `storageService` connect `storageService` to `.notify`, `EventDay`, `lucide-react`, `verify_question_flow.ts`, `storageService.ts`, `UserRole`, `.getEvents`, `CollegeEvent`, `react`, `.getParties`, `Learner`, `App.tsx`, `.setItem`, `Volunteer`, `index.ts`, `verify_question_flow.js`, `ScoreGridTab.tsx`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `presenceService` connect `presenceService` to `CollegeEvent`, `App.tsx`, `storageService.ts`?**
