...
## Corpus Check
- 136 files · ~183,552 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1096 nodes · 2935 edges · 77 communities (53 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02d5da92`
...
1. `storageService` - 236 edges
2. `Learner` - 87 edges
3. `react` - 53 edges
4. `Party` - 53 edges
5. `lucide-react` - 50 edges
6. `Committee` - 41 edges
7. `CollegeEvent` - 39 edges
...
### Community 5 - "Learner"
Cohesion: 0.17
Nodes (24): AddLearnerModal(), AddLearnerModalProps, AllocationModal(), AllocationModalProps, AllocationTabProps, AnalyticsTab(), AnalyticsTabProps, AwardsTabProps (+16 more)
...
Cohesion: 0.05
Nodes (92): EventTabRouteHandlerProps, DaysActivitiesTabProps, EditDayActivitiesModal(), EditDayActivitiesModalProps, StandaloneProjectorDisplayProps, AgendaTabProps, CATEGORY_OPTIONS, DURATION_PRESETS (+84 more)
...
Cohesion: 0.06
Nodes (47): react-router-dom, storageMap, assert(), runTests(), App(), EventSlugOnlyRedirector(), EventTabRouteHandler(), getInitialRouteInfo() (+39 more)
...
Cohesion: 0.16
Nodes (19): CsvImportModal(), CsvImportModalProps, ImportReportData, DownloadModal(), DownloadModalProps, ReportTab(), ReportTabProps, CSVImportResult (+11 more)
...
- **Why does `storageService` connect `storageService` to `.notify`, `verify_question_flow.js`, `verify_question_flow.ts`, `Learner`, `ParticipantsTab.tsx`, `UserRole`, `.setItem`, `react`, `storageService.ts`, `App.tsx`, `csvHelper.ts`, `Volunteer`, `.getEvents`, `.sbUpsert`, `.syncFromSupabase`?**
...
- **Why does `react` connect `react` to `package.json`, `Learner`, `ParticipantsTab.tsx`, `UserRole`, `storageService.ts`, `App.tsx`, `csvHelper.ts`, `Volunteer`?**
