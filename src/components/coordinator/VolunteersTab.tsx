    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-amber-700 dark:text-amber-400 font-medium mt-0.5 flex items-center gap-1.5">
            <KeyRound className="w-3.5 h-3.5" />
            <span>Volunteers sign in at <strong>/yip/join</strong> with their code to run voting kiosks on event day.</span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="px-3.5 py-2 rounded-xl text-xs font-bold border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 shadow-sm flex items-center gap-1.5"
          >
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="pt-1">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg border border-amber-200 dark:border-amber-800/50 bg-amber-50/60 dark:bg-amber-950/30 text-amber-700 dark:text-amber-300 font-mono font-bold text-xs flex items-center gap-1.5 hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-colors"
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-white font-bold text-xs shadow-sm"
              >
